...
ALL_PERMISSIONS = frozenset({TENANT_READ, TENANT_MANAGE, TEMPLATE_READ, TEMPLATE_WRITE, TASK_READ, TASK_CREATE, TASK_MANAGE, MEMBER_READ, MEMBER_MANAGE, OWNER_MANAGE})
ROLE_PERMISSIONS = {
    ROLE_OWNER: ALL_PERMISSIONS,
    ROLE_ADMIN: frozenset({TENANT_READ, TEMPLATE_READ, TEMPLATE_WRITE, TASK_READ, TASK_CREATE, TASK_MANAGE, MEMBER_READ}),
