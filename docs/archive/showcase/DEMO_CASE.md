...
Version: `v2.0-paperforge` (current public release)
...
Current public demo baseline: tag `v2.0-paperforge`. The older `v1.0-showcase` and `v0.9.x` labels identify historical demo packages only.
